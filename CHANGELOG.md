...
- Added validation for latitude, longitude, depth, and scan interval.
- Added offline unit coverage for config flow, coordinator parsing, lake/model mapping, and test discovery.
